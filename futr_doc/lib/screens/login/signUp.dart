            ...
            child: Container(
                ...
                child: SingleChildScrollView(
                  child: Column(children: <Widget>[
                    ...
                    CustomTextFormField(
                        onEditingComplete: () {}, labelText: 'FIRST NAME'),
                    SizedBox(height: MediaQuery.of(context).size.height * .025),
                    CustomTextFormField(
                        onEditingComplete: () {}, labelText: 'LAST NAME'),
                    SizedBox(
                      height: MediaQuery.of(context).size.height * .025,
                    ),
                    CustomTextFormField(
                        onEditingComplete: () {}, labelText: 'EMAIL'),
                    SizedBox(height: MediaQuery.of(context).size.height * .025),
                    CustomTextFormField(
                        onEditingComplete: () {}, labelText: 'PASSWORD'),
                    SizedBox(height: MediaQuery.of(context).size.height * .025),
                    CustomTextFormField(
                        onEditingComplete: () {}, labelText: 'CONFIM PASSWORD'),
                    SizedBox(height: MediaQuery.of(context).size.height * .025),
                    Row(
                      children: <Widget>[
                        Checkbox(
                        ...
                        Container(
                          ...
                          child: Text('I AGREE TO THE PRIVACY POLICY AND TERMS OF SERVICE',
